...
name_one = 'sIMoN'
name_two = 'SimON'
print(name_one == name_two) # False, ecause of the different casing
...
ten_charecters = testing_tabs.expandtabs(10)
fifteen_charecters = testing_tabs.expandtabs(15)
twenty_charecters = testing_tabs.expandtabs(20)
print(ten_charecters)
print(fifteen_charecters)
print(twenty_charecters)
...
# print(num_one.isdecimal()) #T
# print(num_two.isdecimal()) #F
# print(num_three.isdecimal()) #F
...
# print(num_four.isdigit()) #T
# print(num_five.isdigit()) #F
# print(num_six.isdigit()) #F
...
print(f'You typed in {first_name}')
print(f'Hello, {first_name} I am counting {length_of_name} charecters')
...
word_vs_num = (length_of_word > number)
print(f'Does {word} have more than {number} letters? {word_vs_num}')
